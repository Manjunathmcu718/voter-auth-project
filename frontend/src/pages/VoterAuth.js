...
import { Shield, Phone, CheckCircle, Vote, ToggleLeft, ToggleRight, AlertCircle } from 'lucide-react';
import axios from 'axios';

import AuthForm from '../components/voter/AuthForm';
import EnhancedAuthForm from '../components/voter/EnhancedAuthForm';
                ...
                <AnimatePresence>
                    {error && (
                        <motion.div initial={{ opacity: 0, y: -10 }} animate={{ opacity: 1, y: 0 }} exit={{ opacity: 0, y: -10 }} className="mb-6 max-w-md mx-auto">
                            {/* --- REPLACED ALERT COMPONENT WITH A SIMPLE DIV --- */}
